...
async function testGreApi() {
  ...
  console.log('Base URL:', 'https://rage-usr-ultra-limitation.trycloudflare.com/')
    
    // Test basic sessions endpoint
  const response = await fetch('https://rage-usr-ultra-limitation.trycloudflare.com/sessions')
  ...
  const connectedResponse = await fetch('https://rage-usr-ultra-limitation.trycloudflare.com/sessions?end_ts=is.null')
